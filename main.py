...
rps_gesture = {0:'rock', 5:'paper', 9:'scissors', 11:'new_scissors'}
...
file = np.genfromtxt('dataset/gesture_train.csv', delimiter=',')
        ...
        for res in result.multi_hand_landmarks:
            ...
            if len(rps_result) >= 2:
                ...
                if rps_result[0]['rps']=='rock':
                    ...
                    elif rps_result[1]['rps']=='new_scissors': text = 'Rock wins'   ; winner = 0
                    ...
                    elif rps_result[1]['rps']=='new_scissors': text = 'Scissors wins'; winner = 1
                    ...
                    elif rps_result[1]['rps']=='new_scissors': text = 'Tie'
                elif rps_result[0]['rps']=='new_scissors':
                    if rps_result[1]['rps']=='rock'     : text = 'Rock wins'   ; winner = 1
                    elif rps_result[1]['rps']=='paper'  : text = 'Scissors wins'; winner = 0
                    elif rps_result[1]['rps']=='scissors': text = 'Tie'
                    elif rps_result[1]['rps']=='new_scissors': text = 'Tie'
